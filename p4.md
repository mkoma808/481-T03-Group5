...
Before starting the design process, we used a "triangulation" method to choose complimentary user reseach methods. A breeder was interviewed that gave us great insight into just how archaric the animal breeding world still is. We then analyzed the historical context and methods used to track breeding animals
