...
Task I : User wants to add single pet entry to database.

Task II: User wishes to calculate the inbreeding coefficient of two of his own animals.
 
Task III: User wants to connect to other breeders and search for a “match” for a specific pet.
